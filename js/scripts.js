            ...
            $.ajax({
                ...
                success: function () {
                    ...
                    $('#success > .alert-success')
                        .append("<strong>Mensaje enviado, me pondré en contacto contigo pronto. </strong>");
                    $('#success > .alert-success')
                        .append('</div>');
                    //clear all fields
                ...
                error: function () {
                    ...
                    $('#success > .alert-danger').html("<button type='button' class='close' data-dismiss='alert' aria-hidden='true'>&times;")
                        .append("</button>");
                    $('#success > .alert-danger').append($("<strong>").text("Lo siento " + firstName + ", al parecer el servicio de correo no está funcionando, por favor intenta más tarde."));
